...
package com.pr.mlkit_translation.analyzer
...
import com.pr.mlkit_translation.util.ImageUtils
...
class TextAnalyzer(
    ...
    fun recognizeText(
        ...
        // Use ML Kit's TextRecognition to analyze frames from the camera live feed.
